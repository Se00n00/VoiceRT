...
class TestCapacity(unittest.TestCase):
    def test_kv_cache_math(self):
        from src.models.runtime.capacity import kv_cache_mb
        # Qwen3-0.6B: 2*28*8*512*128*2B / MiB = 56.0MB
        self.assertAlmostEqual(kv_cache_mb(), 56.0, places=6)

    def test_session_price_grows_with_genlen(self):
        from src.models.runtime.capacity import estimate_session_mb
    ...
    def test_plan_clamps(self):
        from src.models.runtime.capacity import plan_capacity
